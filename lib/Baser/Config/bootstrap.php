 ...
 */
	...
	if (preg_match('/^' . $updateKey . '(|\/index\/)/', $parameter)) {
		...
		if(!isConsole()) {
			...
			throw new BcException(__d('baser_dev', 'Since the version of the program and the database are different, it forcibly terminates. Adjust the version of the database and try again.'));
		}
	}
