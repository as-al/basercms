...
<?php if ($blogContent['BlogContent']['comment_use']): ?>
	...
	<div id="BlogComment">
		...
		<div style="text-align:center;background-color:#8ABE08;"> <span style="color:white;"><?php echo __('Comment on this article') ?></span> </div>
		<hr size="1" style="width:100%;height:1px;margin:2px 0;padding:0;color:#CCCCCC;background:#CCCCCC;border:1px solid #CCCCCC;" />
		...
		<br />
		<hr size="1" style="width:100%;height:1px;margin:2px 0;padding:0;color:#CCCCCC;background:#CCCCCC;border:1px solid #CCCCCC;" />
		<div style="text-align:center;background-color:#8ABE08;"> <span style="color:white;"><?php echo __('Send comments') ?></span> </div>
		<hr size="1" style="width:100%;height:1px;margin:2px 0;padding:0;color:#CCCCCC;background:#CCCCCC;border:1px solid #CCCCCC;" />
		...
		<?php echo $this->BcForm->label('BlogComment.name', __('Name')) ?><br />
		<?php echo $this->BcForm->text('BlogComment.name') ?><br />
		<span style="color:red;"><?php echo $this->BcForm->error('BlogComment.name') ?></span> 
		<?php echo $this->BcForm->label('BlogComment.email', __('Email')) ?>&nbsp;<small>※ <?php echo __('Do not publish') ?></small><br />
		...
		<?php echo $this->BcForm->label('BlogComment.message', __('Comment')) ?><br />
		...
		<?php echo $this->BcForm->end(array('label' => '　　' . __('Submit') . '　　', 'id' => 'BlogCommentAddButton')) ?>
