...
<?php if ($mailContent['MailContent']['auth_captcha']): ?>
	<?php if (!$freezed): ?>
		<div class="auth-captcha clearfix">
			...
			<br />
			&nbsp;<?php echo __('Please enter the letters of the image') ?><br clear="all" />
			<?php echo $this->Mailform->error('MailMessage.auth_captcha', __('The entered characters are incorrect. Please try input again.')) ?>
		</div>
	<?php else: ?>
...
<div class="submit">
	<?php if ($freezed): ?>
		<?php echo $this->Mailform->submit('　' . __('Rewrite') . '　', array('div' => false, 'class' => 'btn-red button form-submit', 'id' => 'BtnMessageBack')) ?>
		<?php echo $this->Mailform->submit('　' . __('Submit') . '　', array('div' => false, 'class' => 'btn-red button form-submit', 'id' => 'BtnMessageSubmit')) ?>
	<?php else: ?>
		<input name="resetdata" value="　<?php echo __('Clear') ?>　" type="reset" class="btn-gray button" />
		<?php echo $this->Mailform->submit('　' . __('Confirm') . '　', array('div' => false, 'class' => 'btn-orange button form-submit', 'id' => 'BtnMessageConfirm')) ?>
	<?php endif; ?>
</div>
