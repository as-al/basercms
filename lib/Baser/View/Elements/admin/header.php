	...
	<?php if ($this->name == 'Installations' || ('/' . $this->request->url == Configure::read('BcAuthPrefix.admin.loginAction')) || (@$this->request->params['prefix'] == 'admin' && $this->BcAdmin->isAdminGlobalmenuUsed())): ?>
		<div class="clearfix" id="HeaderInner">
			...
			<?php if ($this->name != 'Installations' && ('/' . $this->request->url != Configure::read('BcAuthPrefix.admin.loginAction'))): ?>
				<div id="GlobalMenu">
					<ul class="clearfix">
						<li id="GlobalMenu1"><?php $this->BcBaser->link(__d('baser', 'Contents'), array('plugin' => '', 'controller' => 'contents', 'action' => 'index')) ?></li>
						<li id="GlobalMenu2"><?php $this->BcBaser->link(__d('baser', 'Widgets'), array('plugin' => '', 'controller' => 'widget_areas', 'action' => 'index')) ?></li>
						<li id="GlobalMenu3"><?php $this->BcBaser->link(__d('baser', 'Themes'), array('plugin' => '', 'controller' => 'themes', 'action' => 'index')) ?></li>
						<li id="GlobalMenu4"><?php $this->BcBaser->link(__d('baser', 'Plugins'), array('plugin' => '', 'controller' => 'plugins', 'action' => 'index')) ?></li>
						<li id="GlobalMenu5"><?php $this->BcBaser->link(__d('baser', 'System'), array('plugin' => '', 'controller' => 'site_configs', 'action' => 'form')) ?></li>
					</ul>
				</div>
			<?php endif ?>
